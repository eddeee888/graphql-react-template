...
export type BookDetailsQuery = { __typename: 'Query', book: { __typename: 'BookResultOk', result?: { __typename: 'Book', id: string, isbn: string, previousBookInSeries?: { __typename: 'Book', id: string } | null, nextBookInSeries?: { __typename: 'Book', id: string } | null } | null } | { __typename: 'ResultError', error: Types.ResultErrorType } };
