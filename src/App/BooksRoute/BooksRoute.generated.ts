...
export type BooksQuery = { __typename: 'Query', books: { __typename: 'BooksResultOk', result: Array<{ __typename: 'Book', id: string, isbn: string }>, pagination: { __typename: 'Pagination', totalPageCount: number } } | { __typename: 'ResultError', error: Types.ResultErrorType } };
