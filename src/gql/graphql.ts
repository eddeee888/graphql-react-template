...
export type BookDetailsFragment = { __typename: 'Book', id: string, isbn: string } & { ' $fragmentName'?: 'BookDetailsFragment' };
...
export type BookDetailsQuery = { book:
    | { __typename: 'BookResultOk', result: (
        { __typename: 'Book', previousBookInSeries: { __typename: 'Book', id: string } | null, nextBookInSeries: { __typename: 'Book', id: string } | null }
        & { ' $fragmentRefs'?: { 'BookDetailsFragment': BookDetailsFragment } }
      ) | null }
